...
nobleBindings.init = function () {
    ...
    this._hciBle.on('data', this.onData.bind(this));
};
...
nobleBindings.onData = function (address, addressType, advertisement, rssi, eir) {
    var serviceUuids = advertisement.serviceUuids;
    var hasScanServiceUuids = (this._scanServiceUuids.length === 0);
    ...
    if (hasScanServiceUuids) {
        ...
        this.emit('data', uuid, advertisement, rssi,eir);
    }
};
